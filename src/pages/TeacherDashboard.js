...
const TeacherDashboard = () => {
  ...
  'http://localhost:8080/api/admin/assessment/all',
  {
    ...
    const fetchStudents = useCallback(async () => {
        ...
        try {
           const res = await axios.get(
  'http://localhost:8080/api/admin/students/all',
  {
    headers: { 'Authorization': `Bearer ${token}` }
  }
);
    ...
    const fetchTeacherSubmissions = useCallback(async (assessmentId) => {
        ...
        try {
            const res = await axios.get(
  `http://localhost:8080/api/assessment/teacher/${assessmentId}/results`,
  {
    headers: { 'Authorization': `Bearer ${token}` }
  }
);
  ...
  newStudent,
  {
    ...
    const handleDeleteAssessment = async (id) => {
        if (window.confirm("Are you sure? This will delete the assessment.")) {
            try {
              await axios.delete(
  `http://localhost:8080/api/admin/assessment/${id}`,
  {
    headers: { 'Authorization': `Bearer ${token}` }
  }
);
    ...
    const handleFinishAssessment = async () => {
        try {
            await axios.put(
  `http://localhost:8080/api/admin/assessment/${selectedAssessmentId}/complete`,
  {},
  {
    headers: { 'Authorization': `Bearer ${token}` }
  }
        ...
        <div style={styles.appLayout}>
            ...
            <aside style={styles.sidebar}>
                <div style={styles.brandWrapper}>
                    ...
                    <h2 style={styles.brandTitle}>quizapp <span style={styles.proBadge}>TEACHER</span></h2>
                </div>   
